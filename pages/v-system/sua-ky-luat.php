...
include (ROOT_PATH . "/layouts/sidebar.php");
  ...
  if(isset($_GET['id']))
  {
    ...
    // set value active
    $nvAC = "SELECT nv.id as idAC, ma_nv, ten_nv, lktkl.id as loai_id, ten_loai 
    FROM khen_thuong_ky_luat ktkl, nhanvien nv, loai_khen_thuong_ky_luat lktkl 
    WHERE nv.id = ktkl.nhanvien_id 
    AND lktkl.id = ktkl.loai_kt_id 
    AND  ma_kt = '$id'";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-gavel mr-2"></i>Kỷ luật</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Chỉnh sửa kỷ luật</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="card card-primary">
            <div class="card-header with-border">
              <h3 class="card-title">Chỉnh sửa kỷ luật</h3>
