      ...
      <div class="row">
        <div class="col-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <a  href="ky-luat.php?p=bonus-discipline&a=discipline&tao-loai" class="btn btn-app bg-secondary">
                <i class="fa fa-plus"></i> Loại kỷ luật
              </a>
              <a href="ky-luat.php?p=bonus-discipline&a=discipline&ky-luat" class="btn btn-app bg-warning">
                <i class="fa fa-user"></i> Kỷ luật nhân viên
              </a>
              <?php 
                if(isset($_GET['tao-loai']) || isset($_GET['ky-luat']))
                  echo "<a href='ky-luat.php?p=bonus-discipline&a=discipline' class='btn btn-app bg-danger'>
          ...
          <div class="card card-primary">
            <div class="card-header with-border">
              <h3 class="card-title">Tạo loại kỷ luật</h3>
          ...
          <div class="card card-primary">
            <div class="card-header with-border">
              <h3 class="card-title">Kỷ luật nhân viên</h3>
              <div class="card-tools pull-right">
                <button type="button" class="btn btn-card-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-card-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              </div>
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <?php 
                      if($_SESSION['level'] == 1)
                        echo "<button type='submit' class='btn btn-warning' name='taoKyLuat'><i class='fa fa-check'></i> Tiến hành kỷ luật</button>";
                    ?>
                  </div>
                  <!-- /.col -->
                </div>
