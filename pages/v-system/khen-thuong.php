        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Khen thưởng nhân viên</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Thao tác chức năng</h3>
            </div>
            <div class="card-body">
              <a  href="khen-thuong.php?p=bonus-discipline&a=bonus&tao-loai" class="btn btn-app bg-secondary">
                <i class="fa fa-plus"></i> Loại khen thưởng
              </a>
              <a href="khen-thuong.php?p=bonus-discipline&a=bonus&khen-thuong" class="btn btn-app bg-success">
                <i class="fa fa-star"></i> Thêm khen thưởng
              </a>
              <?php 
                if(isset($_GET['tao-loai']) || isset($_GET['khen-thuong']))
                  echo "<a href='khen-thuong.php?p=bonus-discipline&a=bonus' class='btn btn-app bg-danger'>
          ...
          <div class="card card-primary">
            <div class="card-header with-border">
              <h3 class="card-title">Tạo loại khen thưởng</h3>
          ...
          <div class="card card-primary">
            <div class="card-header with-border">
              <h3 class="card-title">Tạo khen thưởng</h3>
              <div class="card-tools pull-right">
                <button type="button" class="btn btn-card-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button type="button" class="btn btn-card-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Danh sách loại khen thưởng</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <?php 
