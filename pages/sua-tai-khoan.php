            ...
            <form role="form" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
<?php
$quyen = $row['quyen'] ?? 0; // Đảm bảo biến không bị lỗi nếu chưa được khai báo
?>
<label>
    <input type="radio" name="level" class="minimal" value="1" <?= ($quyen == 1) ? "checked" : "" ?>> Quản trị viên
</label>
<label>
    <input type="radio" name="level" class="minimal" value="2" <?= ($quyen == 2) ? "checked" : "" ?>> Trưởng phòng
</label>
<label>
    <input type="radio" name="level" class="minimal" value="3" <?= ($quyen == 3) ? "checked" : "" ?>> Phó phòng
</label>
<label>
    <input type="radio" name="level" class="minimal" value="4" <?= ($quyen == 4) ? "checked" : "" ?>> Trưởng nhóm
</label>
<label>
    <input type="radio" name="level" class="minimal" value="0" <?= ($quyen == 0) ? "checked" : "" ?>> Nhân viên
</label>
